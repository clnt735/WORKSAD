...
<head>
    ...
    <title>Account Settings - WorkMuna</title>
    ...
    * {
    ...
    .settings-main .card-body label:first-child {
        margin-top: 0;
    }

    .settings-main .card-body input[type="email"],
    .settings-main .card-body input[type="password"],
    .settings-main .card-body input[type="text"] {
        width: 100%;
    ...
    .settings-main .card-body input:focus {
        outline: none;
        border-color: #1f7bff;
        box-shadow: 0 0 0 3px rgba(31, 123, 255, 0.1);
    }

    .settings-main .card-body input::placeholder {
        color: #a0aec0;
    }

    .settings-main .field.readonly {
        padding: 0.75rem 1rem;
        background: #f1f5f9;
        border: 1px solid #e2e8f0;
        border-radius: 8px;
    ...
    .settings-main .otp-row label {
        margin-top: 0 !important;
    }

    .settings-main .card-actions {
        display: flex;
        gap: 0.75rem;
        margin-top: 1.5rem;
        flex-wrap: wrap;
    ...
    .settings-main .btn:not(.btn-primary) {
        background: #1f7bff;
        color: #fff;
    }

    .settings-main .btn.secondary:hover,
    .settings-main .btn:not(.btn-primary):hover {
        background: #1a6de0;
    }
    ...
    .settings-main .form-message {
        margin-top: 1rem;
        font-size: 0.875rem;
        color: #4a5568;
    }

    .settings-main .form-message:empty {
        display: none;
    }
